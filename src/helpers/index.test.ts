...
describe('getUrlsFromJson', () => {
  ...
  it('should return parsed JSON correctly when tuples are defined', () => {
    const urls = getUrlsFromJson('[["abc", "https://www.foo.software"], ["123", "https://www.google.com"]]');
    expect(urls).toEqual(['abc::https://www.foo.software', '123::https://www.google.com']);
  });
  ...
  it('should throw an error if array item is larger than a tuple', () => {
    expect(() => {
      getUrlsFromJson('[["abc", "https://www.foo.software", "oh no"], ["123", "https://www.google.com"]]');
    }).toThrow();
  });
});

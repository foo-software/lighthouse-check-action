...
describe('convertOptionsFromArguments', () => {
  ...
  it('should use default values when arguments are non-existent', () => {
    ...
    const actual = (0, _arguments.convertOptionsFromArguments)({
      nonexistent: {
        type: 'string',
        value: 'lorem'
      },
  ...
  it('should create correct types from CLI string argument', () => {
    const options = (0, _arguments.convertOptionsFromArguments)({
      myEmptyString: {
        type: 'string',
        value: ''
      },
    ...
    expect(options.myBooleanFalse).toEqual(false); // the CLI argument present with no arguments is interpretted as `true`

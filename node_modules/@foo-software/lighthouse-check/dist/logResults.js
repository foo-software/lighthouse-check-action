...
var _default = ({
  ...
  if (isLocalAudit) {
    let message = 'You can now save Lighthouse audits online to maintain a historical record!\n\n'; // depending on how the user is running this module - provide a respective link

    if (isGitHubAction) {
      message += 'https://github.com/foo-software/lighthouse-check-action#usage-automated-lighthouse-check-api';
    } else if (isOrb) {
      message += 'https://github.com/foo-software/lighthouse-check-orb#usage-automated-lighthouse-check-api';
    } else {
      message += 'https://www.automated-lighthouse-check.com/\n' + 'https://github.com/foo-software/lighthouse-check#automated-lighthouse-check-api-usage';
    } // plug

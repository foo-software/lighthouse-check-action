...
var _default = ({
  ...
  try {
    ...
    const outputDirectoryPath = !outputDirectory ? outputDirectory : _path.default.resolve(outputDirectory);
    ...
    if (!isLocalAudit) {
      ...
      if (triggerResult.data) {
        ...
        const queueIds = triggerResult.data.reduce((accumulator, current) => [...accumulator, ...(!current.id ? [] : [current.id])], []);

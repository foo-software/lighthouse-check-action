...
exports.default = async ({ awsAccessKeyId: accessKeyId, awsBucket: Bucket, awsRegion: region, awsSecretAccessKey: secretAccessKey, config: customConfig, finalScreenshotAwsBucket, isExperimental, options: customOptions, outputDirectory, updateReport, psiKey, timeout, url, }) => {
    // will upload to S3?

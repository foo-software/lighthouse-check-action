...
var _util = _interopRequireDefault(require("lighthouse/lighthouse-core/report/html/renderer/util"));
...
var _default = result => result.categories.performance.auditRefs.reduce((accumulator, audit) => {
  ...
  if (audit.group !== 'load-opportunities' || _util.default.showAsPassed(auditResult)) {
    return accumulator;
  }
  ...
  return [...accumulator, { ...audit,
    result: { ...auditResult,
      // "average" | "fail" | "pass" | ...
      rating: _util.default.calculateRating(auditResult.score, auditResult.scoreDisplayMode)
    }
  }];

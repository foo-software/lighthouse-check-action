...
export declare class EventManager implements IEventManager {
    ...
    registerEvent(event: Message.EventMessage, contextId: CommonDataTypes.BrowsingContext | null): Promise<void>;
    registerPromiseEvent(event: Promise<Message.EventMessage>, contextId: CommonDataTypes.BrowsingContext | null, eventName: Session.SubscribeParametersEvent): Promise<void>;

...
export declare class Realm {
    ...
    constructor(realmStorage: RealmStorage, browsingContextStorage: BrowsingContextStorage, realmId: string, browsingContextId: string, executionContextId: Protocol.Runtime.ExecutionContextId, origin: string, type: RealmType, sandbox: string | undefined, cdpSessionId: string, cdpClient: CdpClient);
    disown(handle: string): Promise<void>;
    cdpToBidiValue(cdpValue: Protocol.Runtime.CallFunctionOnResponse | Protocol.Runtime.EvaluateResponse, resultOwnership: Script.OwnershipModel): Promise<CommonDataTypes.RemoteValue>;

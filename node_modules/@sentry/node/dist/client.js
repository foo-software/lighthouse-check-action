...
var NodeClient = /** @class */ (function (_super) {
    ...
    NodeClient.prototype.initSessionFlusher = function () {
        ...
        if (!release) {
            utils_1.isDebugBuild() && utils_1.logger.warn('Cannot initialise an instance of SessionFlusher if no release is provided!');
        }
        else {
    ...
    NodeClient.prototype._captureRequestSession = function () {
        if (!this._sessionFlusher) {
            utils_1.isDebugBuild() && utils_1.logger.warn('Discarded request mode session because autoSessionTracking option was disabled');
        }
        else {

...
function logAndExitProcess(error) {
    ...
    if (client === undefined) {
        utils_1.isDebugBuild() && utils_1.logger.warn('No NodeClient was defined, we are exiting the process now.');
    ...
    utils_1.forget(client.close(timeout).then(function (result) {
        if (!result) {
            utils_1.isDebugBuild() && utils_1.logger.warn('We reached the timeout for emptying the request buffer, still exiting now!');
        }
        global.process.exit(1);
    }));
}
